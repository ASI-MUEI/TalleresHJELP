...
import com.hjelp.backend.rest.dtos.ErroresDto;
...
public class ControllerAdvice {
    ...
    private final static String CAMPO_DUPLICADO_EXCEPTION_CODE =
            "project.exceptions.CampoDuplicadoException";
    ...
    private final static String CATEGORIA_DUPLICADA_EXCEPTION_CODE =
            "project.exceptions.CategoriaDuplicadaException";
